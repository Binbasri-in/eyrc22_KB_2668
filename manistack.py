...
class Ur5Moveit:
    ...
    lx=np.array([[1,0,0],[0 , 0.091866 , 0.99577],[0 , -0.99577 , 0.091866]])
    ly=np.array([[0.9999997 , 0 , -0.00080285],[0,1,0],[0.00080285 , 0 , 0.9999997]])
    lz=np.array([[0.9999987 , 0.001588 , 0],[-0.001588 , 0.9999987 , 0],[0,0,1]])
    left_look=[lx,ly,lz]
#------------------------------Constructor--------------------------------------------------------
    def __init__(self):
...
def main():
    ...
    while not rospy.is_shutdown():
        (red_trans,red_orient)=lister.lookupTransform('/ebot_base','/fruit_red',rospy.Time(0))
        (yellow_trans,yellow_orient)=lister.lookupTransform('/ebot_base','/fruit_yellow',rospy.Time(0))
    del ur5
